<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $dari = $_POST['dari'];
        $ke = $_POST['ke'];
        $usia_dewasa = $_POST['usia_dewasa'];
        $usia_bayi = $_POST['usia_bayi'];
        $waktu = $_POST['waktu'];

        $result = mysqli_query($db, 
        "INSERT INTO booking_tiket (nama, email, pasword, dari, ke, usia_dewasa, usia_bayi, waktu) 
        VALUES ('$nama','$email','$password','$dari','$ke','$usia_dewasa','$usia_bayi','$waktu')");
